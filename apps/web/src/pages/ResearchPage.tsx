    ...
    <div className="bg-white rounded-xl border border-[#E8E4DF]">
      <div className="flex items-center">
        <button
          ...
          className="flex-1 flex items-center justify-between px-5 py-4 text-left hover:bg-neutral-50 transition-colors rounded-l-xl"
        >
        ...
        <button
          ...
          className="px-3 py-4 text-neutral-300 hover:text-red-400 transition-colors shrink-0"
          title="삭제"
        >
          <svg
            className="w-4 h-4"
