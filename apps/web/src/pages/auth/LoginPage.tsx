  ...
  return (
    <AuthLayout title="로그인" subtitle="계정에 로그인하세요">
      ...
      <div className="space-y-3">
        {oauthNotice && (
          <div className="flex items-center gap-2 px-3 py-2.5 rounded-lg bg-amber-50 border border-amber-200 text-sm text-amber-700">
            <svg
        ...
        <button
          ...
          className="flex items-center justify-center gap-3 w-full py-3 px-4 rounded-lg border border-neutral-200 bg-white text-neutral-400 font-medium text-sm cursor-not-allowed opacity-60"
        >
        ...
        <button
          type="button"
          onClick={() => setOauthNotice(true)}
          className="flex items-center justify-center gap-3 w-full py-3 px-4 rounded-lg text-sm font-medium cursor-not-allowed opacity-60"
        ...
        <button
          type="button"
          onClick={() => setOauthNotice(true)}
          className="flex items-center justify-center gap-3 w-full py-3 px-4 rounded-lg bg-neutral-900 text-white text-sm font-medium cursor-not-allowed opacity-60"
        >
